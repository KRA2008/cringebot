...
namespace Cringebot.Tests.ViewModel
{
    ...
    public class MainViewModelTests
    {
        ...
        private Mock<IPersistentStorage> _dataStore;
        ...
        public void SetupViewModel()
        {
            ...
            _dataStore = new Mock<IPersistentStorage>();
            _dataStore.Setup(d => d.LoadOrDefault(PersistentStorage.SETTINGS_STORE_KEY, It.IsAny<Settings>()))
                .Returns(_settings);
            _dataStore.Setup(d => d.LoadOrDefault(PersistentStorage.SIMULATE_STORE_KEY, It.IsAny<bool>())).Returns(false);
            _dataStore.Setup(d => d.LoadOrDefault(PersistentStorage.LIMIT_LIST_STORE_KEY, It.IsAny<bool>())).Returns(false);
            _dataStore.Setup(d => d.LoadOrDefault(PersistentStorage.MEMORY_LIST_STORE_KEY, It.IsAny<List<Memory>>())).Returns(new List<Memory>());
        ...
        public class InitMethod : MainViewModelTests
        {
            ...
            {
                //arrange
                _dataStore.Setup(w => w.LoadOrDefault(PersistentStorage.SIMULATE_STORE_KEY, false)).Returns(expectedStoredSetting);
            ...
            {
                //arrange
                _dataStore.Setup(w => w.LoadOrDefault(PersistentStorage.LIMIT_LIST_STORE_KEY, false)).Returns(expectedStoredSetting);
            ...
            public void ShouldLoadSavedStateOfListOrDefault()
            {
                ...
                _dataStore.Setup(w => w.LoadOrDefault(PersistentStorage.MEMORY_LIST_STORE_KEY, new List<Memory>())).Returns(expectedList);
            ...
            public void ShouldStartNotificationsIfSimulateOn()
            {
                ...
                _dataStore.Setup(d => d.LoadOrDefault(PersistentStorage.SIMULATE_STORE_KEY, It.IsAny<bool>()))
                    .Returns(true);
        ...
        public class LimitListVisibilityProperty : MainViewModelTests
        {
            ...
            [Test]
            public void ShouldCauseMemoryListToShowNothingWhenOneMemoryMatchesButNullTyped()
            {
                //arrange
                _viewModel.MemoryInput = "aaa1";
                _viewModel.AddMemoryCommand.Execute(null);
        ...
        public class AddMemoryCommand : MainViewModelTests
        {
            ...
            [Test]
            public void ShouldNotAddMemoryIfInputIsNull()
            {
                //arrange
                _viewModel.MemoryInput = "something whatever!";
                _viewModel.AddMemoryCommand.Execute(null);
        ...
        public class DisplayMemoriesProperty : MainViewModelTests
        {
            ...
            [Test]
            public void ShouldDisplayFullListAlphabeticallyWhenInputNull()
            {
                //arrange
                var mem1 = "b";
                var mem2 = "c";
        ...
        public class SaveMethod : MainViewModelTests
        {
            ...
            public void ShouldSaveStateOfSimulate(bool simulate)
            {
                ...
                //assert
                _dataStore.Verify(d => d.Save(PersistentStorage.SIMULATE_STORE_KEY, simulate));
            }
            ...
            public void ShouldSaveStateOfShowList(bool showList)
            {
                ...
                //assert
                _dataStore.Verify(d => d.Save(PersistentStorage.LIMIT_LIST_STORE_KEY, showList));
            }
            ...
            public void ShouldSaveSettings()
            {
                ...
                //assert
                _dataStore.Verify(d => d.Save(PersistentStorage.SETTINGS_STORE_KEY, settings));
            }
            ...
            public void ShouldSaveStateOfList()
            {
                ...
                _dataStore.Setup(d => d.Save(PersistentStorage.MEMORY_LIST_STORE_KEY, It.IsAny<object>())).Callback<string, object>((s, l) =>
                {
        ...
        public class ViewIsAppearingMethod : MainViewModelTests
        {
            ...
            public async Task Should_go_to_help_page_if_first_opening_ever()
            {
                ...
                var coreMethods = new Mock<IPageModelCoreMethods>();
                _viewModel.CoreMethods = coreMethods.Object;
                _dataStore.Setup(d => d.LoadOrDefault(PersistentStorage.HAS_OPENED_BEFORE, false)).Returns(false);
                ...
                _dataStore.Verify(d => d.Save(PersistentStorage.HAS_OPENED_BEFORE, true));
            }
            ...
            public async Task Should_NOT_go_to_help_page_if_NOT_first_opening_ever()
            {
                ...
                var coreMethods = new Mock<IPageModelCoreMethods>();
                _viewModel.CoreMethods = coreMethods.Object;
                _dataStore.Setup(d => d.LoadOrDefault(PersistentStorage.HAS_OPENED_BEFORE, false)).Returns(true);
